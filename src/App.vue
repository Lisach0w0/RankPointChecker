...
<template>
  <nav class="navbar" role="navigation" aria-label="main navigation">
    ...
    <div id="navbarBasicExample" :class="['navbar-menu',{'is-active': state.burgerStatus}]">
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="buttons">
            <a v-if="state.currentUser" class="button is-light" @click="signInWithGoogle">signInWithGoogle</a>
